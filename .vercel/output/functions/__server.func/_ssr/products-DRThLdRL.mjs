//#region node_modules/.nitro/vite/services/ssr/assets/products-DRThLdRL.js
var products = [
	{
	...
	},
	{
		...
		overview: "BISS Labs provides advanced Damper Test Systems engineered for the performance evaluation and durability testing of suspension components. Our systems accurately simulate real-world operating conditions to measure damping characteristics, endurance, and dynamic behaviour. Available in single-station, dual-station, and multi-station configurations, these systems are ideal for automotive OEMs, component manufacturers, and research laboratories.",
		features: [
			"Servo-hydraulic control",
			"Dynamic load simulation",
			"Single & multi-station systems",
	...
	},
	{
		...
		overview: "Extend the life and performance of your existing testing equipment with BISS upgrade and retrofit solutions. Our engineering team modernizes legacy systems by integrating advanced controllers, software, sensors, actuators, and safety features without replacing the complete machine.",
		services: [
			"Controller upgrades",
	...
	},
	{
		...
		overview: "BISS provides a comprehensive range of testing accessories to enhance the capability, flexibility, and accuracy of material testing systems. Every accessory is designed for precise specimen handling and repeatable testing.",
		products: [
			"Grips",
			"Fixtures",
			"Compression Platens",
	...
	},
	{
		...
		overview: "Our intelligent digital controllers deliver accurate machine control, data acquisition, and test automation for mechanical and structural testing applications.",
		features: [
			"Closed-loop control",
	...
	},
	{
		...
		overview: "BISS offers high-performance actuators for static, dynamic, fatigue, and structural testing. Designed for long-term reliability, they provide precise force and displacement control across a wide range of applications.",
		applications: [
			"Fatigue Testing",
			"Structural Testing",
			"Component Validation",
	...
	},
	{
		...
		overview: "Reliable specimen gripping is essential for accurate testing. BISS provides a wide selection of grips and fixtures for tensile, compression, flexural, shear, peel, and torsion testing across various materials.",
		products: [
			"Wedge Grips",
			"Hydraulic Grips",
			"Mechanical Grips",
	...
	},
	{
		...
		overview: "BISS precision load cells provide highly accurate force measurement for mechanical testing systems. Engineered for durability and repeatability, they ensure reliable data collection across low-force and high-capacity applications.",
		features: [
			"High accuracy",
			"Wide force ranges",
			"Long-term stability",
	...
	},
	{
		...
		overview: "Measure strain with exceptional precision using BISS extensometers. Our solutions support contact and non-contact strain measurement for tensile, compression, fatigue, and high-temperature testing.",
		applications: [
			"Metals",
			"Plastics",
			"Composites",
	...
	},
	{
		...
		overview: "BISS testing software simplifies machine operation, data acquisition, analysis, and report generation. Designed for research, production, and quality laboratories, our software enables efficient testing with customizable workflows and automated reporting.",
		features: [
			"Test automation",
	...
	},
	{
		...
		overview: "Accurate testing begins with precise calibration. BISS offers calibration equipment and services to ensure testing machines maintain accuracy, repeatability, and compliance with national and international standards.",
		services: [
			"Force Calibration",
